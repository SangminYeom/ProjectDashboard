...
- 프로젝트 카드 그리드. 카드 내용: 프로젝트명, 기간, KPI 평균 달성률(수치형 KPI만 평균, 정성형 제외), 과제 건수, 중점수행과제 요약(과제별 진척률 막대), 지연 태스크 수, 미해결 고려사항 수 배지
- 진척률은 중점수행과제 단위까지만 관리 — 프로젝트 단위 진척률(과제 평균)은 표시하지 않고, 과제 요약에 과제별 진척률을 나란히 표시
- `+ 새 프로젝트` 카드
